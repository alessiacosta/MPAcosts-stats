...
m1 = lm(lCost_km ~ scale(Size) + scale(Years) + scale(GDP_pc) + Protection_level, esubs, family=gaussian)
summary(m1)
plot(m1)
...
#making a frequentist model 
m2 = lm(Cost_km ~ scale(log(Size)) + Administration + Enforcement + Management, msubs, family=gaussian)
summary(m2)

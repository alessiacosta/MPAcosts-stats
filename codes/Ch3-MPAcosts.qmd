...
neGDP_pc <- 
  ggplot(pred_GDP, aes(x = GDP_pc, y = median)) +
    geom_line(size = 0.8, linetype = "dashed", color = "#1B5E20") +
    geom_ribbon(aes(ymin = lower.HPD, ymax = upper.HPD), fill = "#3A6B3A", alpha = 0.2, color = NA) +
    scale_y_continuous(
      labels = label_number(),
      limits = c(0, 200000)) +
    scale_x_continuous(
...
leGDP_pc <- 
 ggplot(pred_GDP, aes(x = GDP_pc, y = median)) +
  geom_line(size = 0.8, linetype = "dashed", color = "#1B5E20") +  # thinner line
  geom_ribbon(aes(ymin = lower.HPD, ymax = upper.HPD), fill = "#3A6B3A", alpha = 0.2, color = NA) +
  geom_point(data = msubs, aes(x = GDP_pc, y = Cost_km), color = "#1B5E20") +
  theme_bw() +
  theme(text = element_text(family = "serif"),
        axis.title = element_blank(), 
        panel.grid.major = element_blank(),

...
nesize_pl <- 
  ...
  # Customize scales
  scale_color_manual(values = c("Fully protected areas" = "#1b9e77", "Multi-use areas" = "#d95f02")) +
  scale_fill_manual(values = c("Fully protected areas" = "#1b9e77", "Multi-use areas" = "#d95f02")) +
